...
# record_sim / collect_sim: wider than demo for dataset diversity (hole stays in view).
COLLECT_PERTURB_XY_M = 0.020
COLLECT_PERTURB_Z_M = 0.010
COLLECT_PERTURB_ROLL_RAD = 0.14
COLLECT_PERTURB_PITCH_RAD = 0.14
COLLECT_PERTURB_YAW_RAD = 0.20
...
CORNER_ALIGN_METHOD = "kabsch"  # "kabsch" | "ibvs" (demo only; baseline → visp_flow/)
IBVS_TWIST_GAIN = 2.0
IBVS_LAMBDA = 0.05
IBVS_PIXEL_TOL = 1.5
IBVS_BLEND_PX = 70.0  # px RMS above this: mostly PnP; below: mostly IBVS
IBVS_STALL_STEPS = 2400
# Direct / photometric IBVS (teach aligned ROI once, SSD + ECC warp)
DVS_ROI_MARGIN_PX = 40
DVS_PATCH_MAX_DIM = 160
DVS_RENDER_SCALE = 0.5  # half-res render for DVS (~4× faster)
DVS_SIM_SUBSTEPS = 2
DVS_SAMPLE_STEP = 4
DVS_MIN_GRAD = 6.0
DVS_MAX_SAMPLES = 300
...
DVS_SSD_TOL = 120.0
DVS_TWIST_GAIN = 1.5
DVS_MAX_STEPS = 600  # render cycles
